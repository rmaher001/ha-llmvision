...
async def test_anthropic_integration():
    ...
    print("🚀 Running Anthropic Structured Output Integration Test")
    print("=" * 60)
    ...
    try:
        ...
        if supports:
            print("   ✓ Anthropic reports structured output support")
        else:
            print("   ✗ Anthropic should support structured output")
            return False
    except Exception as e:
    ...
    try:
        ...
        if "tools" not in text_payload and "tool_choice" not in text_payload:
            print("   ✓ Text mode does not add tool config (backward compatible)")
        else:
            print("   ✗ Text mode incorrectly adds tool config")
            return False
    except Exception as e:
    ...
    try:
        ...
        if ("tools" in structured_payload and 
            ...
            print(f"   ✗ Structured mode missing correct tool config: {structured_payload}")
            return False
    except Exception as e:
...
async def main():
    ...
    try:
        ...
        if success:
            ...
            print()
            print("✅ Anthropic structured output implementation is working correctly:")
